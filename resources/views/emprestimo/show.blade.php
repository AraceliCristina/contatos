...
@section('content')
    <div class="card w-50">
        ...
        <div class="card-body">
            ...
            Data:
            {{\Carbon\Carbon::create($emprestimo->datahora)->format('d/m/Y H:i:s')}} | Devolução: {!!$emprestimo->devolvido!!}
            <br/>
        ...
        <div class="card-footer">
            ...
            {{Form::open(['route' => ['emprestimos.devolver',$emprestimo->id],'method'=>'GET'])}}
